...
export interface L1OrbitERC20GatewayInterface extends utils.Interface {
    contractName: "L1OrbitERC20Gateway";
    functions: {
...
export interface L1OrbitERC20Gateway extends BaseContract {
    contractName: "L1OrbitERC20Gateway";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: L1OrbitERC20GatewayInterface;
