...
export interface L2ForwarderFactoryInterface extends utils.Interface {
    contractName: "L2ForwarderFactory";
    functions: {
...
export interface L2ForwarderFactory extends BaseContract {
    contractName: "L2ForwarderFactory";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: L2ForwarderFactoryInterface;
