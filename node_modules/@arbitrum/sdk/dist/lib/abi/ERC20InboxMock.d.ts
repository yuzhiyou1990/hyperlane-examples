...
export interface ERC20InboxMockInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "setMockNativeToken", values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: "setMockNativeToken", data: BytesLike): Result;
    events: {
...
export type ERC20InboxRetryableTicketEventFilter = TypedEventFilter<ERC20InboxRetryableTicketEvent>;
...
export interface ERC20InboxMock extends BaseContract {
    ...
    functions: {
        ...
        setMockNativeToken(_nativeToken: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    activeOutbox(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        setMockNativeToken(_nativeToken: string, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        "ERC20InboxRetryableTicket(address,address,uint256,uint256,uint256,uint256,bytes)"(from?: null, to?: null, l2CallValue?: null, maxGas?: null, gasPrice?: null, tokenTotalFeeAmount?: null, data?: null): ERC20InboxRetryableTicketEventFilter;
        ERC20InboxRetryableTicket(from?: null, to?: null, l2CallValue?: null, maxGas?: null, gasPrice?: null, tokenTotalFeeAmount?: null, data?: null): ERC20InboxRetryableTicketEventFilter;
