...
export interface Multicall2Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "tryAggregateGasRation", values: [boolean, Multicall2.CallStruct[]]): string;
...
export interface Multicall2 extends BaseContract {
    ...
    functions: {
        ...
        tryAggregateGasRation(requireSuccess: boolean, calls: Multicall2.CallStruct[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        tryAggregateGasRation(requireSuccess: boolean, calls: Multicall2.CallStruct[], overrides?: CallOverrides): Promise<Multicall2.ResultStructOutput[]>;
