...
export interface L1OrbitCustomGatewayInterface extends utils.Interface {
    contractName: "L1OrbitCustomGateway";
    functions: {
...
export interface L1OrbitCustomGateway extends BaseContract {
    contractName: "L1OrbitCustomGateway";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: L1OrbitCustomGatewayInterface;
