...
export interface L2CustomGatewayTokenInterface extends utils.Interface {
    contractName: "L2CustomGatewayToken";
    functions: {
...
export interface L2CustomGatewayToken extends BaseContract {
    contractName: "L2CustomGatewayToken";
    ...
    functions: {
        ...
        initialize(name_: string, symbol_: string, decimals_: BigNumberish, l2Gateway_: string, l1Counterpart_: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        initialize(name_: string, symbol_: string, decimals_: BigNumberish, l2Gateway_: string, l1Counterpart_: string, overrides?: CallOverrides): Promise<void>;
        l1Address(overrides?: CallOverrides): Promise<string>;
        l2Gateway(overrides?: CallOverrides): Promise<string>;
        name(overrides?: CallOverrides): Promise<string>;
        nonces(owner: string, overrides?: CallOverrides): Promise<BigNumber>;
