...
export interface IRollupUserInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "newStakeOnNewNode", values: [AssertionStruct, BytesLike, BigNumberish]): string;
...
export interface IRollupUser extends BaseContract {
    ...
    functions: {
        ...
        newStakeOnNewNode(assertion: AssertionStruct, expectedNodeHash: BytesLike, prevNodeInboxMaxCount: BigNumberish, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        newStakeOnNewNode(assertion: AssertionStruct, expectedNodeHash: BytesLike, prevNodeInboxMaxCount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        nodeHasStaker(nodeNum: BigNumberish, staker: string, overrides?: CallOverrides): Promise<boolean>;
        outbox(overrides?: CallOverrides): Promise<string>;
        owner(overrides?: CallOverrides): Promise<string>;
