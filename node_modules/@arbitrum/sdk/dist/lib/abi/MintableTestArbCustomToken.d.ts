...
export interface MintableTestArbCustomTokenInterface extends utils.Interface {
    contractName: "MintableTestArbCustomToken";
    functions: {
        ...
        "userMint(address,uint256)": FunctionFragment;
    };
    ...
    encodeFunctionData(functionFragment: "someWackyCustomStuff", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "userMint", values: [string, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "someWackyCustomStuff", data: BytesLike): Result;
...
export interface MintableTestArbCustomToken extends BaseContract {
    contractName: "MintableTestArbCustomToken";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MintableTestArbCustomTokenInterface;
    ...
    functions: {
        ...
        someWackyCustomStuff(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        userMint(account: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    DOMAIN_SEPARATOR(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        userMint(account: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
