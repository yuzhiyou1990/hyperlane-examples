...
export interface IL2ForwarderInterface extends utils.Interface {
    contractName: "IL2Forwarder";
    functions: {
...
export interface IL2Forwarder extends BaseContract {
    contractName: "IL2Forwarder";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IL2ForwarderInterface;
