...
export interface TestArbCustomTokenBurnFeeInterface extends utils.Interface {
    contractName: "TestArbCustomTokenBurnFee";
    functions: {
...
export interface TestArbCustomTokenBurnFee extends BaseContract {
    contractName: "TestArbCustomTokenBurnFee";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestArbCustomTokenBurnFeeInterface;
