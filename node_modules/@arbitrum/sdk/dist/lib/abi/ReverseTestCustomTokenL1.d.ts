...
export interface ReverseTestCustomTokenL1Interface extends utils.Interface {
    contractName: "ReverseTestCustomTokenL1";
    functions: {
...
export interface ReverseTestCustomTokenL1 extends BaseContract {
    contractName: "ReverseTestCustomTokenL1";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ReverseTestCustomTokenL1Interface;
