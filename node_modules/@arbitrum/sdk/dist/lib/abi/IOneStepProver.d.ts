...
export interface IOneStepProver extends BaseContract {
    ...
    functions: {
        executeOneStep(execCtx: ExecutionContextStruct, mach: MachineStruct, mod: ModuleStruct, instruction: InstructionStruct, proof: BytesLike, overrides?: CallOverrides): Promise<[
            MachineStructOutput,
            ModuleStructOutput
        ] & {
    ...
    filters: {};
    estimateGas: {
        executeOneStep(execCtx: ExecutionContextStruct, mach: MachineStruct, mod: ModuleStruct, instruction: InstructionStruct, proof: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        executeOneStep(execCtx: ExecutionContextStruct, mach: MachineStruct, mod: ModuleStruct, instruction: InstructionStruct, proof: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
