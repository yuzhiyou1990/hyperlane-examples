...
export interface StandardArbERC20Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "bridgeInit", values: [string, BytesLike]): string;
...
export interface StandardArbERC20 extends BaseContract {
    ...
    functions: {
        ...
        bridgeInit(_l1Address: string, _data: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        bridgeInit(_l1Address: string, _data: BytesLike, overrides?: CallOverrides): Promise<void>;
