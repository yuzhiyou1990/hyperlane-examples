...
export interface ERC20OutboxInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "l2ToL1WithdrawalAmount", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "l2ToL1WithdrawalAmount", data: BytesLike): Result;
...
export interface ERC20Outbox extends BaseContract {
    ...
    populateTransaction: {
        ...
        l2ToL1WithdrawalAmount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        postUpgradeInit(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
