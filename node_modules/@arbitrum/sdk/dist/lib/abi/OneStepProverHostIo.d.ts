...
export interface OneStepProverHostIo extends BaseContract {
    ...
    functions: {
        executeOneStep(execCtx: ExecutionContextStruct, startMach: MachineStruct, startMod: ModuleStruct, inst: InstructionStruct, proof: BytesLike, overrides?: CallOverrides): Promise<[
            MachineStructOutput,
            ModuleStructOutput
        ] & {
    ...
    filters: {};
    estimateGas: {
        executeOneStep(execCtx: ExecutionContextStruct, startMach: MachineStruct, startMod: ModuleStruct, inst: InstructionStruct, proof: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        executeOneStep(execCtx: ExecutionContextStruct, startMach: MachineStruct, startMod: ModuleStruct, inst: InstructionStruct, proof: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
