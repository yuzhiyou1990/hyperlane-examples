...
export interface MintableTestCustomTokenL1Interface extends utils.Interface {
    contractName: "MintableTestCustomTokenL1";
    functions: {
...
export interface MintableTestCustomTokenL1 extends BaseContract {
    contractName: "MintableTestCustomTokenL1";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MintableTestCustomTokenL1Interface;
    ...
    functions: {
        ...
        registerTokenOnL2(l2CustomTokenAddress: string, maxSubmissionCostForCustomGateway: BigNumberish, maxSubmissionCostForRouter: BigNumberish, maxGasForCustomGateway: BigNumberish, maxGasForRouter: BigNumberish, gasPriceBid: BigNumberish, valueForGateway: BigNumberish, valueForRouter: BigNumberish, creditBackAddress: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
