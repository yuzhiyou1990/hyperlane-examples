...
export interface TestOrbitCustomTokenL1Interface extends utils.Interface {
    contractName: "TestOrbitCustomTokenL1";
    functions: {
...
export interface TestOrbitCustomTokenL1 extends BaseContract {
    contractName: "TestOrbitCustomTokenL1";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestOrbitCustomTokenL1Interface;
