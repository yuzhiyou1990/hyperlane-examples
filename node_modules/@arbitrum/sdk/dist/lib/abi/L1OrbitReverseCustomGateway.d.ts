...
export interface L1OrbitReverseCustomGatewayInterface extends utils.Interface {
    contractName: "L1OrbitReverseCustomGateway";
    functions: {
...
export interface L1OrbitReverseCustomGateway extends BaseContract {
    contractName: "L1OrbitReverseCustomGateway";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: L1OrbitReverseCustomGatewayInterface;
    ...
    functions: {
        ...
        "forceRegisterTokenToL2(address[],address[],uint256,uint256,uint256)"(arg0: string[], arg1: string[], arg2: BigNumberish, arg3: BigNumberish, arg4: BigNumberish, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "forceRegisterTokenToL2(address[],address[],uint256,uint256,uint256,uint256)"(_l1Addresses: string[], _l2Addresses: string[], _maxGas: BigNumberish, _gasPriceBid: BigNumberish, _maxSubmissionCost: BigNumberish, _feeAmount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        "registerTokenToL2(address,uint256,uint256,uint256,address,uint256)"(_l2Address: string, _maxGas: BigNumberish, _gasPriceBid: BigNumberish, _maxSubmissionCost: BigNumberish, _creditBackAddress: string, _feeAmount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "registerTokenToL2(address,uint256,uint256,uint256,uint256)"(_l2Address: string, _maxGas: BigNumberish, _gasPriceBid: BigNumberish, _maxSubmissionCost: BigNumberish, _feeAmount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "registerTokenToL2(address,uint256,uint256,uint256,address)"(arg0: string, arg1: BigNumberish, arg2: BigNumberish, arg3: BigNumberish, arg4: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "registerTokenToL2(address,uint256,uint256,uint256)"(arg0: string, arg1: BigNumberish, arg2: BigNumberish, arg3: BigNumberish, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "forceRegisterTokenToL2(address[],address[],uint256,uint256,uint256)"(arg0: string[], arg1: string[], arg2: BigNumberish, arg3: BigNumberish, arg4: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "forceRegisterTokenToL2(address[],address[],uint256,uint256,uint256,uint256)"(_l1Addresses: string[], _l2Addresses: string[], _maxGas: BigNumberish, _gasPriceBid: BigNumberish, _maxSubmissionCost: BigNumberish, _feeAmount: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getExternalCall(_exitNum: BigNumberish, _initialDestination: string, _initialData: BytesLike, overrides?: CallOverrides): Promise<[string, string] & {
            target: string;
            data: string;
        }>;
        ...
        "registerTokenToL2(address,uint256,uint256,uint256,address,uint256)"(_l2Address: string, _maxGas: BigNumberish, _gasPriceBid: BigNumberish, _maxSubmissionCost: BigNumberish, _creditBackAddress: string, _feeAmount: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "registerTokenToL2(address,uint256,uint256,uint256,uint256)"(_l2Address: string, _maxGas: BigNumberish, _gasPriceBid: BigNumberish, _maxSubmissionCost: BigNumberish, _feeAmount: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "registerTokenToL2(address,uint256,uint256,uint256,address)"(arg0: string, arg1: BigNumberish, arg2: BigNumberish, arg3: BigNumberish, arg4: string, overrides?: CallOverrides): Promise<BigNumber>;
        "registerTokenToL2(address,uint256,uint256,uint256)"(arg0: string, arg1: BigNumberish, arg2: BigNumberish, arg3: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        router(overrides?: CallOverrides): Promise<string>;
