...
export type WithdrawTriggeredEventFilter = TypedEventFilter<WithdrawTriggeredEvent>;
...
export interface RollupMock extends BaseContract {
    ...
    functions: {
        removeOldZombies(arg0: BigNumberish, overrides?: Overrides & {
    ...
    callStatic: {
        removeOldZombies(arg0: BigNumberish, overrides?: CallOverrides): Promise<void>;
