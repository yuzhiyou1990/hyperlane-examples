...
export interface ReverseTestArbCustomTokenInterface extends utils.Interface {
    contractName: "ReverseTestArbCustomToken";
    functions: {
...
export interface ReverseTestArbCustomToken extends BaseContract {
    contractName: "ReverseTestArbCustomToken";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ReverseTestArbCustomTokenInterface;
