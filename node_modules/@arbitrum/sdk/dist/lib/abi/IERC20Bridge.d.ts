...
export interface IERC20BridgeInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "enqueueDelayedMessage", values: [BigNumberish, string, BytesLike, BigNumberish]): string;
...
export interface IERC20Bridge extends BaseContract {
    ...
    functions: {
        ...
        allowedDelayedInboxList(arg0: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        allowedDelayedInboxes(inbox: string, overrides?: CallOverrides): Promise<[boolean]>;
        allowedOutboxList(arg0: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        enqueueDelayedMessage(kind: BigNumberish, sender: string, messageDataHash: BytesLike, tokenFeeAmount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        initialize(rollup_: string, nativeToken_: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        delayedInboxAccs(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
        delayedMessageCount(overrides?: CallOverrides): Promise<BigNumber>;
        enqueueDelayedMessage(kind: BigNumberish, sender: string, messageDataHash: BytesLike, tokenFeeAmount: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        initialize(rollup_: string, nativeToken_: string, overrides?: CallOverrides): Promise<void>;
        nativeToken(overrides?: CallOverrides): Promise<string>;
        rollup(overrides?: CallOverrides): Promise<string>;
        sequencerInbox(overrides?: CallOverrides): Promise<string>;
        sequencerInboxAccs(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
