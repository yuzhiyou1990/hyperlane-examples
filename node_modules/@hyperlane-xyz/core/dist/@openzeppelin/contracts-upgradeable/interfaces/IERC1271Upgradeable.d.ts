...
export interface IERC1271UpgradeableInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "isValidSignature" | "isValidSignature(bytes32,bytes)"): FunctionFragment;
...
export interface IERC1271Upgradeable extends BaseContract {
    ...
    functions: {
        ...
        "isValidSignature(bytes32,bytes)"(hash: BytesLike, signature: BytesLike, overrides?: CallOverrides): Promise<[string] & {
            magicValue: string;
        }>;
    };
    isValidSignature(hash: BytesLike, signature: BytesLike, overrides?: CallOverrides): Promise<string>;
    ...
    estimateGas: {
        ...
        "isValidSignature(bytes32,bytes)"(hash: BytesLike, signature: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        isValidSignature(hash: BytesLike, signature: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "isValidSignature(bytes32,bytes)"(hash: BytesLike, signature: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
