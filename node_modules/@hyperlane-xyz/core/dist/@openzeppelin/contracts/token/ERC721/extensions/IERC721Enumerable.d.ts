...
export interface IERC721EnumerableInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "approve" | "approve(address,uint256)" | "balanceOf" | "balanceOf(address)" | "getApproved" | "getApproved(uint256)" | "isApprovedForAll" | "isApprovedForAll(address,address)" | "ownerOf" | "ownerOf(uint256)" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "setApprovalForAll(address,bool)" | "supportsInterface" | "supportsInterface(bytes4)" | "tokenByIndex" | "tokenByIndex(uint256)" | "tokenOfOwnerByIndex" | "tokenOfOwnerByIndex(address,uint256)" | "totalSupply" | "totalSupply()" | "transferFrom" | "transferFrom(address,address,uint256)"): FunctionFragment;
