...
export interface IAccessControlInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getRoleAdmin" | "getRoleAdmin(bytes32)" | "grantRole" | "grantRole(bytes32,address)" | "hasRole" | "hasRole(bytes32,address)" | "renounceRole" | "renounceRole(bytes32,address)" | "revokeRole" | "revokeRole(bytes32,address)"): FunctionFragment;
