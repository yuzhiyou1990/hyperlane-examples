...
export interface ITransparentUpgradeableProxyInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "admin" | "admin()" | "changeAdmin" | "changeAdmin(address)" | "implementation" | "implementation()" | "upgradeTo" | "upgradeTo(address)" | "upgradeToAndCall" | "upgradeToAndCall(address,bytes)"): FunctionFragment;
    encodeFunctionData(functionFragment: "admin", values?: undefined): string;
    encodeFunctionData(functionFragment: "admin()", values?: undefined): string;
    encodeFunctionData(functionFragment: "changeAdmin", values: [string]): string;
    encodeFunctionData(functionFragment: "changeAdmin(address)", values: [string]): string;
    encodeFunctionData(functionFragment: "implementation", values?: undefined): string;
    encodeFunctionData(functionFragment: "implementation()", values?: undefined): string;
    encodeFunctionData(functionFragment: "upgradeTo", values: [string]): string;
    encodeFunctionData(functionFragment: "upgradeTo(address)", values: [string]): string;
    encodeFunctionData(functionFragment: "upgradeToAndCall", values: [string, BytesLike]): string;
    encodeFunctionData(functionFragment: "upgradeToAndCall(address,bytes)", values: [string, BytesLike]): string;
    decodeFunctionResult(functionFragment: "admin", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "admin()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "changeAdmin", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "changeAdmin(address)", data: BytesLike): Result;
...
export interface ITransparentUpgradeableProxy extends BaseContract {
    ...
    functions: {
        ...
        "changeAdmin(address)"(arg0: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "upgradeTo(address)"(arg0: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        upgradeToAndCall(arg0: string, arg1: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "upgradeToAndCall(address,bytes)"(arg0: string, arg1: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    admin(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        "changeAdmin(address)"(arg0: string, overrides?: CallOverrides): Promise<void>;
        implementation(overrides?: CallOverrides): Promise<string>;
        "implementation()"(overrides?: CallOverrides): Promise<string>;
        upgradeTo(arg0: string, overrides?: CallOverrides): Promise<void>;
        "upgradeTo(address)"(arg0: string, overrides?: CallOverrides): Promise<void>;
        upgradeToAndCall(arg0: string, arg1: BytesLike, overrides?: CallOverrides): Promise<void>;
        "upgradeToAndCall(address,bytes)"(arg0: string, arg1: BytesLike, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
...
//# sourceMappingURL=ITransparentUpgradeableProxy.d.ts.map