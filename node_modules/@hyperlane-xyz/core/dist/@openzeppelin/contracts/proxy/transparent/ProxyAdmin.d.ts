...
export interface ProxyAdminInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "changeProxyAdmin" | "changeProxyAdmin(address,address)" | "getProxyAdmin" | "getProxyAdmin(address)" | "getProxyImplementation" | "getProxyImplementation(address)" | "owner" | "owner()" | "renounceOwnership" | "renounceOwnership()" | "transferOwnership" | "transferOwnership(address)" | "upgrade" | "upgrade(address,address)" | "upgradeAndCall" | "upgradeAndCall(address,address,bytes)"): FunctionFragment;
    encodeFunctionData(functionFragment: "changeProxyAdmin", values: [string, string]): string;
    encodeFunctionData(functionFragment: "changeProxyAdmin(address,address)", values: [string, string]): string;
    encodeFunctionData(functionFragment: "getProxyAdmin", values: [string]): string;
    encodeFunctionData(functionFragment: "getProxyAdmin(address)", values: [string]): string;
    encodeFunctionData(functionFragment: "getProxyImplementation", values: [string]): string;
    encodeFunctionData(functionFragment: "getProxyImplementation(address)", values: [string]): string;
    ...
    encodeFunctionData(functionFragment: "upgrade(address,address)", values: [string, string]): string;
    encodeFunctionData(functionFragment: "upgradeAndCall", values: [string, string, BytesLike]): string;
    encodeFunctionData(functionFragment: "upgradeAndCall(address,address,bytes)", values: [string, string, BytesLike]): string;
    decodeFunctionResult(functionFragment: "changeProxyAdmin", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "changeProxyAdmin(address,address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getProxyAdmin", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getProxyAdmin(address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getProxyImplementation", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getProxyImplementation(address)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "upgrade(address,address)", data: BytesLike): Result;
...
export interface ProxyAdmin extends BaseContract {
    ...
    functions: {
        ...
        "changeProxyAdmin(address,address)"(proxy: string, newAdmin: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "upgrade(address,address)"(proxy: string, implementation: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        upgradeAndCall(proxy: string, implementation: string, data: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "upgradeAndCall(address,address,bytes)"(proxy: string, implementation: string, data: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    changeProxyAdmin(proxy: string, newAdmin: string, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        "changeProxyAdmin(address,address)"(proxy: string, newAdmin: string, overrides?: CallOverrides): Promise<void>;
        getProxyAdmin(proxy: string, overrides?: CallOverrides): Promise<string>;
        "getProxyAdmin(address)"(proxy: string, overrides?: CallOverrides): Promise<string>;
        getProxyImplementation(proxy: string, overrides?: CallOverrides): Promise<string>;
        "getProxyImplementation(address)"(proxy: string, overrides?: CallOverrides): Promise<string>;
        ...
        "upgrade(address,address)"(proxy: string, implementation: string, overrides?: CallOverrides): Promise<void>;
        upgradeAndCall(proxy: string, implementation: string, data: BytesLike, overrides?: CallOverrides): Promise<void>;
        "upgradeAndCall(address,address,bytes)"(proxy: string, implementation: string, data: BytesLike, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
    ...
    populateTransaction: {
        ...
        "getProxyAdmin(address)"(proxy: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getProxyImplementation(proxy: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "getProxyImplementation(address)"(proxy: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
