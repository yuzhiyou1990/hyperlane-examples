...
export interface IERC4626 extends BaseContract {
    ...
    functions: {
        ...
        "maxDeposit(address)"(receiver: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            maxAssets: BigNumber;
        }>;
        maxMint(receiver: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            maxShares: BigNumber;
        }>;
        "maxMint(address)"(receiver: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            maxShares: BigNumber;
        }>;
    ...
    populateTransaction: {
        ...
        "maxDeposit(address)"(receiver: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        maxMint(receiver: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "maxMint(address)"(receiver: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
