...
export interface ICrossDomainMessengerInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "sendMessage" | "sendMessage(address,bytes,uint32)" | "xDomainMessageSender" | "xDomainMessageSender()"): FunctionFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "FailedRelayedMessage(bytes32)"): EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "SentMessage(address,address,bytes,uint256,uint256)"): EventFragment;
}
...
export interface ICrossDomainMessenger extends BaseContract {
    ...
    functions: {
        ...
        "sendMessage(address,bytes,uint32)"(_target: string, _message: BytesLike, _gasLimit: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
