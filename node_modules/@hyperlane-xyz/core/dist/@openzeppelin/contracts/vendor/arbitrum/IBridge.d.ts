...
export interface IBridgeInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "activeOutbox" | "activeOutbox()" | "allowedDelayedInboxList" | "allowedDelayedInboxList(uint256)" | "allowedDelayedInboxes" | "allowedDelayedInboxes(address)" | "allowedOutboxList" | "allowedOutboxList(uint256)" | "allowedOutboxes" | "allowedOutboxes(address)" | "delayedInboxAccs" | "delayedInboxAccs(uint256)" | "delayedMessageCount" | "delayedMessageCount()" | "enqueueDelayedMessage" | "enqueueDelayedMessage(uint8,address,bytes32)" | "enqueueSequencerMessage" | "enqueueSequencerMessage(bytes32,uint256,uint256,uint256)" | "executeCall" | "executeCall(address,uint256,bytes)" | "initialize" | "initialize(address)" | "rollup" | "rollup()" | "sequencerInbox" | "sequencerInbox()" | "sequencerInboxAccs" | "sequencerInboxAccs(uint256)" | "sequencerMessageCount" | "sequencerMessageCount()" | "sequencerReportedSubMessageCount" | "sequencerReportedSubMessageCount()" | "setDelayedInbox" | "setDelayedInbox(address,bool)" | "setOutbox" | "setOutbox(address,bool)" | "setSequencerInbox" | "setSequencerInbox(address)" | "submitBatchSpendingReport" | "submitBatchSpendingReport(address,bytes32)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "allowedDelayedInboxList(uint256)", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "allowedDelayedInboxes", values: [string]): string;
    encodeFunctionData(functionFragment: "allowedDelayedInboxes(address)", values: [string]): string;
    encodeFunctionData(functionFragment: "allowedOutboxList", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "allowedOutboxList(uint256)", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "allowedOutboxes", values: [string]): string;
    encodeFunctionData(functionFragment: "allowedOutboxes(address)", values: [string]): string;
    encodeFunctionData(functionFragment: "delayedInboxAccs", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "delayedInboxAccs(uint256)", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "enqueueDelayedMessage(uint8,address,bytes32)", values: [BigNumberish, string, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "enqueueSequencerMessage(bytes32,uint256,uint256,uint256)", values: [BytesLike, BigNumberish, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "executeCall", values: [string, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "executeCall(address,uint256,bytes)", values: [string, BigNumberish, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "sequencerInboxAccs(uint256)", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "setDelayedInbox(address,bool)", values: [string, boolean]): string;
    encodeFunctionData(functionFragment: "setOutbox", values: [string, boolean]): string;
    encodeFunctionData(functionFragment: "setOutbox(address,bool)", values: [string, boolean]): string;
    encodeFunctionData(functionFragment: "setSequencerInbox", values: [string]): string;
    encodeFunctionData(functionFragment: "setSequencerInbox(address)", values: [string]): string;
    encodeFunctionData(functionFragment: "submitBatchSpendingReport", values: [string, BytesLike]): string;
    encodeFunctionData(functionFragment: "submitBatchSpendingReport(address,bytes32)", values: [string, BytesLike]): string;
    ...
    decodeFunctionResult(functionFragment: "allowedDelayedInboxList(uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "allowedDelayedInboxes", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "allowedDelayedInboxes(address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "allowedOutboxList", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "allowedOutboxList(uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "allowedOutboxes", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "allowedOutboxes(address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "delayedInboxAccs", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "delayedInboxAccs(uint256)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "enqueueDelayedMessage(uint8,address,bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "enqueueSequencerMessage", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "enqueueSequencerMessage(bytes32,uint256,uint256,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "executeCall", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "executeCall(address,uint256,bytes)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "sequencerInboxAccs(uint256)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setDelayedInbox(address,bool)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setOutbox", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setOutbox(address,bool)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setSequencerInbox", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setSequencerInbox(address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "submitBatchSpendingReport", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "submitBatchSpendingReport(address,bytes32)", data: BytesLike): Result;
    events: {
    ...
    getEvent(nameOrSignatureOrTopic: "BridgeCallTriggered(address,address,uint256,bytes)"): EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "MessageDelivered(uint256,bytes32,address,uint8,address,bytes32,uint256,uint64)"): EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "SequencerInboxUpdated(address)"): EventFragment;
}
...
export interface IBridge extends BaseContract {
    ...
    functions: {
        ...
        "allowedDelayedInboxList(uint256)"(arg0: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        allowedDelayedInboxes(inbox: string, overrides?: CallOverrides): Promise<[boolean]>;
        "allowedDelayedInboxes(address)"(inbox: string, overrides?: CallOverrides): Promise<[boolean]>;
        allowedOutboxList(arg0: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "allowedOutboxList(uint256)"(arg0: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        allowedOutboxes(outbox: string, overrides?: CallOverrides): Promise<[boolean]>;
        "allowedOutboxes(address)"(outbox: string, overrides?: CallOverrides): Promise<[boolean]>;
        delayedInboxAccs(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        "delayedInboxAccs(uint256)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        ...
        "enqueueDelayedMessage(uint8,address,bytes32)"(kind: BigNumberish, sender: string, messageDataHash: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "enqueueSequencerMessage(bytes32,uint256,uint256,uint256)"(dataHash: BytesLike, afterDelayedMessagesRead: BigNumberish, prevMessageCount: BigNumberish, newMessageCount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        executeCall(to: string, value: BigNumberish, data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "executeCall(address,uint256,bytes)"(to: string, value: BigNumberish, data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        initialize(rollup_: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "initialize(address)"(rollup_: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "sequencerInboxAccs(uint256)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        ...
        "setDelayedInbox(address,bool)"(inbox: string, enabled: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setOutbox(inbox: string, enabled: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "setOutbox(address,bool)"(inbox: string, enabled: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setSequencerInbox(_sequencerInbox: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "setSequencerInbox(address)"(_sequencerInbox: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        submitBatchSpendingReport(batchPoster: string, dataHash: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "submitBatchSpendingReport(address,bytes32)"(batchPoster: string, dataHash: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    activeOutbox(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        "allowedDelayedInboxList(uint256)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
        allowedDelayedInboxes(inbox: string, overrides?: CallOverrides): Promise<boolean>;
        "allowedDelayedInboxes(address)"(inbox: string, overrides?: CallOverrides): Promise<boolean>;
        allowedOutboxList(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
        "allowedOutboxList(uint256)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
        allowedOutboxes(outbox: string, overrides?: CallOverrides): Promise<boolean>;
        "allowedOutboxes(address)"(outbox: string, overrides?: CallOverrides): Promise<boolean>;
        delayedInboxAccs(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
        "delayedInboxAccs(uint256)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
        ...
        "enqueueDelayedMessage(uint8,address,bytes32)"(kind: BigNumberish, sender: string, messageDataHash: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        "enqueueSequencerMessage(bytes32,uint256,uint256,uint256)"(dataHash: BytesLike, afterDelayedMessagesRead: BigNumberish, prevMessageCount: BigNumberish, newMessageCount: BigNumberish, overrides?: CallOverrides): Promise<[
            BigNumber,
            string,
            string,
            string
        ...
        "executeCall(address,uint256,bytes)"(to: string, value: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<[boolean, string] & {
            success: boolean;
            returnData: string;
        }>;
        initialize(rollup_: string, overrides?: CallOverrides): Promise<void>;
        "initialize(address)"(rollup_: string, overrides?: CallOverrides): Promise<void>;
        rollup(overrides?: CallOverrides): Promise<string>;
        "rollup()"(overrides?: CallOverrides): Promise<string>;
        sequencerInbox(overrides?: CallOverrides): Promise<string>;
        "sequencerInbox()"(overrides?: CallOverrides): Promise<string>;
        ...
        "setDelayedInbox(address,bool)"(inbox: string, enabled: boolean, overrides?: CallOverrides): Promise<void>;
        setOutbox(inbox: string, enabled: boolean, overrides?: CallOverrides): Promise<void>;
        "setOutbox(address,bool)"(inbox: string, enabled: boolean, overrides?: CallOverrides): Promise<void>;
        setSequencerInbox(_sequencerInbox: string, overrides?: CallOverrides): Promise<void>;
        "setSequencerInbox(address)"(_sequencerInbox: string, overrides?: CallOverrides): Promise<void>;
        submitBatchSpendingReport(batchPoster: string, dataHash: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        "submitBatchSpendingReport(address,bytes32)"(batchPoster: string, dataHash: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {
    ...
    estimateGas: {
        ...
        "allowedDelayedInboxes(address)"(inbox: string, overrides?: CallOverrides): Promise<BigNumber>;
        allowedOutboxList(arg0: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        "allowedOutboxList(uint256)"(arg0: BigNumberish, overrides?: Overrides & {
        ...
        "allowedOutboxes(address)"(outbox: string, overrides?: CallOverrides): Promise<BigNumber>;
        delayedInboxAccs(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "delayedInboxAccs(uint256)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        delayedMessageCount(overrides?: CallOverrides): Promise<BigNumber>;
        "delayedMessageCount()"(overrides?: CallOverrides): Promise<BigNumber>;
        enqueueDelayedMessage(kind: BigNumberish, sender: string, messageDataHash: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        ...
        "sequencerInboxAccs(uint256)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        sequencerMessageCount(overrides?: CallOverrides): Promise<BigNumber>;
        "sequencerMessageCount()"(overrides?: CallOverrides): Promise<BigNumber>;
        sequencerReportedSubMessageCount(overrides?: CallOverrides): Promise<BigNumber>;
        "sequencerReportedSubMessageCount()"(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        "allowedDelayedInboxes(address)"(inbox: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        allowedOutboxList(arg0: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        "allowedOutboxList(uint256)"(arg0: BigNumberish, overrides?: Overrides & {
        ...
        "allowedOutboxes(address)"(outbox: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        delayedInboxAccs(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "delayedInboxAccs(uint256)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        "sequencerInboxAccs(uint256)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
