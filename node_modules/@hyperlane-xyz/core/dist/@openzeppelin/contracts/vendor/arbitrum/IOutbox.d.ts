...
export interface IOutboxInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "OUTBOX_VERSION" | "OUTBOX_VERSION()" | "bridge" | "bridge()" | "calculateItemHash" | "calculateItemHash(address,address,uint256,uint256,uint256,uint256,bytes)" | "calculateMerkleRoot" | "calculateMerkleRoot(bytes32[],uint256,bytes32)" | "executeTransaction" | "executeTransaction(bytes32[],uint256,address,address,uint256,uint256,uint256,uint256,bytes)" | "executeTransactionSimulation" | "executeTransactionSimulation(uint256,address,address,uint256,uint256,uint256,uint256,bytes)" | "isSpent" | "isSpent(uint256)" | "l2ToL1Block" | "l2ToL1Block()" | "l2ToL1EthBlock" | "l2ToL1EthBlock()" | "l2ToL1OutputId" | "l2ToL1OutputId()" | "l2ToL1Sender" | "l2ToL1Sender()" | "l2ToL1Timestamp" | "l2ToL1Timestamp()" | "rollup" | "rollup()" | "roots" | "roots(bytes32)" | "spent" | "spent(uint256)" | "updateSendRoot" | "updateSendRoot(bytes32,bytes32)"): FunctionFragment;
