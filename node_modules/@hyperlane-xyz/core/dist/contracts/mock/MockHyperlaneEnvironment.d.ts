...
export interface MockHyperlaneEnvironmentInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "destinationDomain" | "destinationDomain()" | "igps" | "igps(uint32)" | "isms" | "isms(uint32)" | "mailboxes" | "mailboxes(uint32)" | "originDomain" | "originDomain()" | "processNextPendingMessage" | "processNextPendingMessage()" | "processNextPendingMessageFromDestination" | "processNextPendingMessageFromDestination()"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "originDomain", values?: undefined): string;
    encodeFunctionData(functionFragment: "originDomain()", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "originDomain", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "originDomain()", data: BytesLike): Result;
...
export interface MockHyperlaneEnvironment extends BaseContract {
    ...
    functions: {
        ...
        "originDomain()"(overrides?: CallOverrides): Promise<[number]>;
        processNextPendingMessage(overrides?: PayableOverrides & {
            from?: string;
