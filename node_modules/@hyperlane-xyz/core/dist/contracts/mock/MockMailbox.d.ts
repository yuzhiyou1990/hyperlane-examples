...
export interface MockMailboxInterface extends utils.Interface {
    functions: {
        ...
        "processInboundMessage(uint32)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "processInboundMessage", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "processInboundMessage(uint32)", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "processInboundMessage", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "processInboundMessage(uint32)", data: BytesLike): Result;
...
export interface MockMailbox extends BaseContract {
    ...
    functions: {
        ...
        processInboundMessage(_nonce: BigNumberish, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "processInboundMessage(uint32)"(_nonce: BigNumberish, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        processNextInboundMessage(overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "processNextInboundMessage()"(overrides?: PayableOverrides & {
            from?: string;
    ...
    callStatic: {
        ...
        processInboundMessage(_nonce: BigNumberish, overrides?: CallOverrides): Promise<void>;
        "processInboundMessage(uint32)"(_nonce: BigNumberish, overrides?: CallOverrides): Promise<void>;
