...
export interface ITokenMessengerInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "depositForBurn" | "depositForBurn(uint256,uint32,bytes32,address)" | "depositForBurnWithCaller" | "depositForBurnWithCaller(uint256,uint32,bytes32,address,bytes32)"): FunctionFragment;
    encodeFunctionData(functionFragment: "depositForBurn", values: [BigNumberish, BigNumberish, BytesLike, string]): string;
    encodeFunctionData(functionFragment: "depositForBurn(uint256,uint32,bytes32,address)", values: [BigNumberish, BigNumberish, BytesLike, string]): string;
    ...
    encodeFunctionData(functionFragment: "depositForBurnWithCaller(uint256,uint32,bytes32,address,bytes32)", values: [BigNumberish, BigNumberish, BytesLike, string, BytesLike]): string;
    decodeFunctionResult(functionFragment: "depositForBurn", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "depositForBurn(uint256,uint32,bytes32,address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "depositForBurnWithCaller", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "depositForBurnWithCaller(uint256,uint32,bytes32,address,bytes32)", data: BytesLike): Result;
    events: {
...
export interface ITokenMessenger extends BaseContract {
    ...
    functions: {
        ...
        "depositForBurn(uint256,uint32,bytes32,address)"(_amount: BigNumberish, _destinationDomain: BigNumberish, _mintRecipient: BytesLike, _burnToken: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "depositForBurnWithCaller(uint256,uint32,bytes32,address,bytes32)"(_amount: BigNumberish, _destinationDomain: BigNumberish, _mintRecipient: BytesLike, _burnToken: string, _destinationCaller: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    depositForBurn(_amount: BigNumberish, _destinationDomain: BigNumberish, _mintRecipient: BytesLike, _burnToken: string, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        "depositForBurn(uint256,uint32,bytes32,address)"(_amount: BigNumberish, _destinationDomain: BigNumberish, _mintRecipient: BytesLike, _burnToken: string, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        "depositForBurnWithCaller(uint256,uint32,bytes32,address,bytes32)"(_amount: BigNumberish, _destinationDomain: BigNumberish, _mintRecipient: BytesLike, _burnToken: string, _destinationCaller: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {
