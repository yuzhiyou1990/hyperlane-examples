...
export interface IPortalTokenBridgeInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "completeTransferWithPayload" | "completeTransferWithPayload(bytes)" | "isWrappedAsset" | "isWrappedAsset(address)" | "parseTransferWithPayload" | "parseTransferWithPayload(bytes)" | "transferTokensWithPayload" | "transferTokensWithPayload(address,uint256,uint16,bytes32,uint32,bytes)" | "wrappedAsset" | "wrappedAsset(uint16,bytes32)"): FunctionFragment;
...
export interface IPortalTokenBridge extends BaseContract {
    ...
    functions: {
        ...
        "isWrappedAsset(address)"(token: string, overrides?: CallOverrides): Promise<[boolean]>;
        ...
        "transferTokensWithPayload(address,uint256,uint16,bytes32,uint32,bytes)"(token: string, amount: BigNumberish, recipientChain: BigNumberish, recipient: BytesLike, nonce: BigNumberish, payload: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        wrappedAsset(tokenChainId: BigNumberish, tokenAddress: BytesLike, overrides?: CallOverrides): Promise<[string]>;
        "wrappedAsset(uint16,bytes32)"(tokenChainId: BigNumberish, tokenAddress: BytesLike, overrides?: CallOverrides): Promise<[string]>;
    };
    completeTransferWithPayload(encodedVm: BytesLike, overrides?: Overrides & {
        from?: string;
    }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "transferTokensWithPayload(address,uint256,uint16,bytes32,uint32,bytes)"(token: string, amount: BigNumberish, recipientChain: BigNumberish, recipient: BytesLike, nonce: BigNumberish, payload: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        wrappedAsset(tokenChainId: BigNumberish, tokenAddress: BytesLike, overrides?: CallOverrides): Promise<string>;
        "wrappedAsset(uint16,bytes32)"(tokenChainId: BigNumberish, tokenAddress: BytesLike, overrides?: CallOverrides): Promise<string>;
    };
    filters: {
    ...
    estimateGas: {
        ...
        "isWrappedAsset(address)"(token: string, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        "wrappedAsset(uint16,bytes32)"(tokenChainId: BigNumberish, tokenAddress: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        completeTransferWithPayload(encodedVm: BytesLike, overrides?: Overrides & {
            from?: string;
        ...
        "isWrappedAsset(address)"(token: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        "wrappedAsset(uint16,bytes32)"(tokenChainId: BigNumberish, tokenAddress: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
