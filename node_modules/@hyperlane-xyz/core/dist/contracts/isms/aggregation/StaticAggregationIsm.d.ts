...
export interface StaticAggregationIsmInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "moduleType" | "moduleType()" | "modulesAndThreshold" | "modulesAndThreshold(bytes)" | "verify" | "verify(bytes,bytes)"): FunctionFragment;
