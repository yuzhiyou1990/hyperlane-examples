...
export interface TrustedRelayerIsmInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "mailbox" | "mailbox()" | "moduleType" | "moduleType()" | "trustedRelayer" | "trustedRelayer()" | "verify" | "verify(bytes,bytes)"): FunctionFragment;
