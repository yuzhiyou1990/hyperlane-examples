...
export interface PolygonPosIsmInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "VERIFIED_MASK_INDEX" | "VERIFIED_MASK_INDEX()" | "authorizedHook" | "authorizedHook()" | "isVerified" | "isVerified(bytes)" | "moduleType" | "moduleType()" | "preVerifyMessage" | "preVerifyMessage(bytes32,uint256)" | "processMessageFromRoot" | "processMessageFromRoot(uint256,address,bytes)" | "releaseValueToRecipient" | "releaseValueToRecipient(bytes)" | "setAuthorizedHook" | "setAuthorizedHook(bytes32)" | "verifiedMessages" | "verifiedMessages(bytes32)" | "verify" | "verify(bytes,bytes)"): FunctionFragment;
