...
export interface StaticMessageIdMultisigIsmInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "moduleType" | "moduleType()" | "signatureCount" | "signatureCount(bytes)" | "validatorsAndThreshold" | "validatorsAndThreshold(bytes)" | "verify" | "verify(bytes,bytes)"): FunctionFragment;
