...
export interface RateLimitedIsmInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DURATION" | "DURATION()" | "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "calculateCurrentLevel" | "calculateCurrentLevel()" | "filledLevel" | "filledLevel()" | "hook" | "hook()" | "interchainSecurityModule" | "interchainSecurityModule()" | "lastUpdated" | "lastUpdated()" | "localDomain" | "localDomain()" | "mailbox" | "mailbox()" | "maxCapacity" | "maxCapacity()" | "messageValidated" | "messageValidated(bytes32)" | "moduleType" | "moduleType()" | "owner" | "owner()" | "recipient" | "recipient()" | "refillRate" | "refillRate()" | "renounceOwnership" | "renounceOwnership()" | "setHook" | "setHook(address)" | "setInterchainSecurityModule" | "setInterchainSecurityModule(address)" | "setRefillRate" | "setRefillRate(uint256)" | "transferOwnership" | "transferOwnership(address)" | "validateAndConsumeFilledLevel" | "validateAndConsumeFilledLevel(uint256)" | "verify" | "verify(bytes,bytes)"): FunctionFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "ConsumedFilledLevel(uint256,uint256)"): EventFragment;
...
export type ConsumedFilledLevelEventFilter = TypedEventFilter<ConsumedFilledLevelEvent>;
...
export interface RateLimitedIsm extends BaseContract {
    ...
    functions: {
        ...
        validateAndConsumeFilledLevel(_consumedAmount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "validateAndConsumeFilledLevel(uint256)"(_consumedAmount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        validateAndConsumeFilledLevel(_consumedAmount: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "validateAndConsumeFilledLevel(uint256)"(_consumedAmount: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    filters: {
        "ConsumedFilledLevel(uint256,uint256)"(filledLevel?: null, lastUpdated?: null): ConsumedFilledLevelEventFilter;
        ConsumedFilledLevel(filledLevel?: null, lastUpdated?: null): ConsumedFilledLevelEventFilter;
