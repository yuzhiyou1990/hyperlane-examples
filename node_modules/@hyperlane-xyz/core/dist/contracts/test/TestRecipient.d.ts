...
export interface TestRecipientInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "fooBar" | "fooBar(uint256,string)" | "handle" | "handle(uint32,bytes32,bytes)" | "interchainSecurityModule" | "interchainSecurityModule()" | "lastCallMessage" | "lastCallMessage()" | "lastCaller" | "lastCaller()" | "lastData" | "lastData()" | "lastSender" | "lastSender()" | "owner" | "owner()" | "renounceOwnership" | "renounceOwnership()" | "setInterchainSecurityModule" | "setInterchainSecurityModule(address)" | "transferOwnership" | "transferOwnership(address)"): FunctionFragment;
    encodeFunctionData(functionFragment: "fooBar", values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "fooBar(uint256,string)", values: [BigNumberish, string]): string;
    ...
    decodeFunctionResult(functionFragment: "fooBar(uint256,string)", data: BytesLike): Result;
    ...
    getEvent(nameOrSignatureOrTopic: "ReceivedCall(address,uint256,string)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ReceivedMessage"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ReceivedMessage(uint32,bytes32,uint256,string)"): EventFragment;
}
...
export interface TestRecipient extends BaseContract {
    ...
    functions: {
        ...
        "fooBar(uint256,string)"(amount: BigNumberish, message: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        handle(_origin: BigNumberish, _sender: BytesLike, _data: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "handle(uint32,bytes32,bytes)"(_origin: BigNumberish, _sender: BytesLike, _data: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "setInterchainSecurityModule(address)"(_ism: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "fooBar(uint256,string)"(amount: BigNumberish, message: string, overrides?: CallOverrides): Promise<void>;
        handle(_origin: BigNumberish, _sender: BytesLike, _data: BytesLike, overrides?: CallOverrides): Promise<void>;
        "handle(uint32,bytes32,bytes)"(_origin: BigNumberish, _sender: BytesLike, _data: BytesLike, overrides?: CallOverrides): Promise<void>;
        interchainSecurityModule(overrides?: CallOverrides): Promise<string>;
        "interchainSecurityModule()"(overrides?: CallOverrides): Promise<string>;
        lastCallMessage(overrides?: CallOverrides): Promise<string>;
        "lastCallMessage()"(overrides?: CallOverrides): Promise<string>;
        ...
        "setInterchainSecurityModule(address)"(_ism: string, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "ReceivedMessage(uint32,bytes32,uint256,string)"(origin?: BigNumberish | null, sender?: BytesLike | null, value?: BigNumberish | null, message?: null): ReceivedMessageEventFilter;
        ReceivedMessage(origin?: BigNumberish | null, sender?: BytesLike | null, value?: BigNumberish | null, message?: null): ReceivedMessageEventFilter;
    };
    estimateGas: {
        fooBar(amount: BigNumberish, message: string, overrides?: Overrides & {
            from?: string;
