...
export interface TestMerkleInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "branchRoot" | "branchRoot(bytes32,bytes32[32],uint256)" | "count" | "count()" | "insert" | "insert(bytes32)" | "root" | "root()" | "tree" | "tree()"): FunctionFragment;
    encodeFunctionData(functionFragment: "branchRoot", values: [BytesLike, BytesLike[], BigNumberish]): string;
    encodeFunctionData(functionFragment: "branchRoot(bytes32,bytes32[32],uint256)", values: [BytesLike, BytesLike[], BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "branchRoot(bytes32,bytes32[32],uint256)", data: BytesLike): Result;
...
export interface TestMerkle extends BaseContract {
    ...
    functions: {
        ...
        "branchRoot(bytes32,bytes32[32],uint256)"(_leaf: BytesLike, _proof: BytesLike[], _index: BigNumberish, overrides?: CallOverrides): Promise<[string] & {
            _node: string;
        }>;
        ...
        "insert(bytes32)"(_node: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "insert(bytes32)"(_node: BytesLike, overrides?: CallOverrides): Promise<void>;
        root(overrides?: CallOverrides): Promise<string>;
        "root()"(overrides?: CallOverrides): Promise<string>;
        tree(overrides?: CallOverrides): Promise<BigNumber>;
        "tree()"(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    estimateGas: {
        ...
        "branchRoot(bytes32,bytes32[32],uint256)"(_leaf: BytesLike, _proof: BytesLike[], _index: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        count(overrides?: CallOverrides): Promise<BigNumber>;
        "count()"(overrides?: CallOverrides): Promise<BigNumber>;
        insert(_node: BytesLike, overrides?: Overrides & {
            from?: string;
    ...
    populateTransaction: {
        ...
        "branchRoot(bytes32,bytes32[32],uint256)"(_leaf: BytesLike, _proof: BytesLike[], _index: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
