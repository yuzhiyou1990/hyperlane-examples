...
export interface TestTokenRecipientInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "fooBar" | "fooBar(uint256,string)" | "handleWithTokens" | "handleWithTokens(uint32,bytes32,bytes,address,uint256)" | "lastAmount" | "lastAmount()" | "lastCallMessage" | "lastCallMessage()" | "lastCaller" | "lastCaller()" | "lastData" | "lastData()" | "lastSender" | "lastSender()" | "lastToken" | "lastToken()"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "handleWithTokens(uint32,bytes32,bytes,address,uint256)", values: [BigNumberish, BytesLike, BytesLike, string, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "handleWithTokens(uint32,bytes32,bytes,address,uint256)", data: BytesLike): Result;
    ...
    getEvent(nameOrSignatureOrTopic: "ReceivedMessage(uint32,bytes32,string,address,uint256)"): EventFragment;
}
...
export interface TestTokenRecipient extends BaseContract {
    ...
    functions: {
        ...
        "handleWithTokens(uint32,bytes32,bytes,address,uint256)"(_origin: BigNumberish, _sender: BytesLike, _data: BytesLike, _token: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "handleWithTokens(uint32,bytes32,bytes,address,uint256)"(_origin: BigNumberish, _sender: BytesLike, _data: BytesLike, _token: string, _amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        lastAmount(overrides?: CallOverrides): Promise<BigNumber>;
        "lastAmount()"(overrides?: CallOverrides): Promise<BigNumber>;
        lastCallMessage(overrides?: CallOverrides): Promise<string>;
        "lastCallMessage()"(overrides?: CallOverrides): Promise<string>;
