...
export interface TestIsmInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "moduleType" | "moduleType()" | "setVerify" | "setVerify(bool)" | "verify" | "verify(bytes,bytes)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "setVerify(bool)", values: [boolean]): string;
    ...
    decodeFunctionResult(functionFragment: "setVerify(bool)", data: BytesLike): Result;
...
export interface TestIsm extends BaseContract {
    ...
    functions: {
        ...
        "moduleType()"(overrides?: CallOverrides): Promise<[number]>;
        setVerify(_verify: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "setVerify(bool)"(_verify: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "setVerify(bool)"(_verify: boolean, overrides?: CallOverrides): Promise<void>;
        verify(arg0: BytesLike, arg1: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        "verify(bytes,bytes)"(arg0: BytesLike, arg1: BytesLike, overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {};
...
//# sourceMappingURL=TestIsm.d.ts.map