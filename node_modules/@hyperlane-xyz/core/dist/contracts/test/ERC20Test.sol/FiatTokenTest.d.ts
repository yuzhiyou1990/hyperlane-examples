...
export interface FiatTokenTestInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "_decimals" | "_decimals()" | "allowance" | "allowance(address,address)" | "approve" | "approve(address,uint256)" | "balanceOf" | "balanceOf(address)" | "burn" | "burn(uint256)" | "burnFrom" | "burnFrom(address,uint256)" | "decimals" | "decimals()" | "decreaseAllowance" | "decreaseAllowance(address,uint256)" | "increaseAllowance" | "increaseAllowance(address,uint256)" | "mint(address,uint256)" | "mint(uint256)" | "mintTo" | "mintTo(address,uint256)" | "name" | "name()" | "symbol" | "symbol()" | "totalSupply" | "totalSupply()" | "transfer" | "transfer(address,uint256)" | "transferFrom" | "transferFrom(address,address,uint256)"): FunctionFragment;
