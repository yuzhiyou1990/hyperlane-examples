...
export interface XERC20TestInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "_decimals" | "_decimals()" | "allowance" | "allowance(address,address)" | "approve" | "approve(address,uint256)" | "balanceOf" | "balanceOf(address)" | "burn" | "burn(address,uint256)" | "burnFrom" | "burnFrom(address,uint256)" | "burningCurrentLimitOf" | "burningCurrentLimitOf(address)" | "burningMaxLimitOf" | "burningMaxLimitOf(address)" | "decimals" | "decimals()" | "decreaseAllowance" | "decreaseAllowance(address,uint256)" | "increaseAllowance" | "increaseAllowance(address,uint256)" | "mint(address,uint256)" | "mint(uint256)" | "mintTo" | "mintTo(address,uint256)" | "mintingCurrentLimitOf" | "mintingCurrentLimitOf(address)" | "mintingMaxLimitOf" | "mintingMaxLimitOf(address)" | "name" | "name()" | "owner" | "owner()" | "setLimits" | "setLimits(address,uint256,uint256)" | "symbol" | "symbol()" | "totalSupply" | "totalSupply()" | "transfer" | "transfer(address,uint256)" | "transferFrom" | "transferFrom(address,address,uint256)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "burnFrom(address,uint256)", values: [string, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "burningMaxLimitOf(address)", values: [string]): string;
    ...
    encodeFunctionData(functionFragment: "mintingMaxLimitOf(address)", values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: "burningMaxLimitOf(address)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "mintingMaxLimitOf(address)", data: BytesLike): Result;
...
export interface XERC20Test extends BaseContract {
    ...
    functions: {
        ...
        "burnFrom(address,uint256)"(account: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "burningMaxLimitOf(address)"(_bridge: string, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        "mintingMaxLimitOf(address)"(_bridge: string, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    populateTransaction: {
        ...
        "burningMaxLimitOf(address)"(_bridge: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        "mintingMaxLimitOf(address)"(_bridge: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
