...
export interface TestQuerySenderInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "handleQueryAddressResult" | "handleQueryAddressResult(address)" | "handleQueryBytes32Result" | "handleQueryBytes32Result(bytes32)" | "handleQueryUint256Result" | "handleQueryUint256Result(uint256)" | "initialize" | "initialize(address)" | "lastAddressResult" | "lastAddressResult()" | "lastBytes32Result" | "lastBytes32Result()" | "lastUint256Result" | "lastUint256Result()" | "queryAddress" | "queryAddress(uint32,address,bytes,uint256)" | "queryBytes32" | "queryBytes32(uint32,address,bytes,uint256)" | "queryUint256" | "queryUint256(uint32,address,bytes,uint256)"): FunctionFragment;
    encodeFunctionData(functionFragment: "handleQueryAddressResult", values: [string]): string;
    encodeFunctionData(functionFragment: "handleQueryAddressResult(address)", values: [string]): string;
    encodeFunctionData(functionFragment: "handleQueryBytes32Result", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "handleQueryBytes32Result(bytes32)", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "handleQueryUint256Result", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "handleQueryUint256Result(uint256)", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "queryAddress(uint32,address,bytes,uint256)", values: [BigNumberish, string, BytesLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "queryBytes32", values: [BigNumberish, string, BytesLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "queryBytes32(uint32,address,bytes,uint256)", values: [BigNumberish, string, BytesLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "queryUint256", values: [BigNumberish, string, BytesLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "queryUint256(uint32,address,bytes,uint256)", values: [BigNumberish, string, BytesLike, BigNumberish]): string;
    decodeFunctionResult(functionFragment: "handleQueryAddressResult", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "handleQueryAddressResult(address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "handleQueryBytes32Result", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "handleQueryBytes32Result(bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "handleQueryUint256Result", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "handleQueryUint256Result(uint256)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "queryAddress(uint32,address,bytes,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "queryBytes32", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "queryBytes32(uint32,address,bytes,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "queryUint256", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "queryUint256(uint32,address,bytes,uint256)", data: BytesLike): Result;
    events: {
    ...
    getEvent(nameOrSignatureOrTopic: "ReceivedAddressResult(address)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ReceivedBytes32Result"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ReceivedBytes32Result(bytes32)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ReceivedUint256Result"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "ReceivedUint256Result(uint256)"): EventFragment;
}
...
export interface TestQuerySender extends BaseContract {
    ...
    functions: {
        ...
        "handleQueryAddressResult(address)"(_result: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        handleQueryBytes32Result(_result: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "handleQueryBytes32Result(bytes32)"(_result: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        handleQueryUint256Result(_result: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "handleQueryUint256Result(uint256)"(_result: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        initialize(_queryRouterAddress: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "initialize(address)"(_queryRouterAddress: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "queryAddress(uint32,address,bytes,uint256)"(_destinationDomain: BigNumberish, _target: string, _targetData: BytesLike, _gasAmount: BigNumberish, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "queryBytes32(uint32,address,bytes,uint256)"(_destinationDomain: BigNumberish, _target: string, _targetData: BytesLike, _gasAmount: BigNumberish, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "queryUint256(uint32,address,bytes,uint256)"(_destinationDomain: BigNumberish, _target: string, _targetData: BytesLike, _gasAmount: BigNumberish, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    handleQueryAddressResult(_result: string, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        "handleQueryAddressResult(address)"(_result: string, overrides?: CallOverrides): Promise<void>;
        handleQueryBytes32Result(_result: BytesLike, overrides?: CallOverrides): Promise<void>;
        "handleQueryBytes32Result(bytes32)"(_result: BytesLike, overrides?: CallOverrides): Promise<void>;
        handleQueryUint256Result(_result: BigNumberish, overrides?: CallOverrides): Promise<void>;
        "handleQueryUint256Result(uint256)"(_result: BigNumberish, overrides?: CallOverrides): Promise<void>;
        initialize(_queryRouterAddress: string, overrides?: CallOverrides): Promise<void>;
        "initialize(address)"(_queryRouterAddress: string, overrides?: CallOverrides): Promise<void>;
        lastAddressResult(overrides?: CallOverrides): Promise<string>;
        "lastAddressResult()"(overrides?: CallOverrides): Promise<string>;
        lastBytes32Result(overrides?: CallOverrides): Promise<string>;
        "lastBytes32Result()"(overrides?: CallOverrides): Promise<string>;
        ...
        "queryAddress(uint32,address,bytes,uint256)"(_destinationDomain: BigNumberish, _target: string, _targetData: BytesLike, _gasAmount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        "queryBytes32(uint32,address,bytes,uint256)"(_destinationDomain: BigNumberish, _target: string, _targetData: BytesLike, _gasAmount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        "queryUint256(uint32,address,bytes,uint256)"(_destinationDomain: BigNumberish, _target: string, _targetData: BytesLike, _gasAmount: BigNumberish, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
