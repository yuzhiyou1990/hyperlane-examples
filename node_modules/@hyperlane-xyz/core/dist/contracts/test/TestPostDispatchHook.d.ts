...
export interface TestPostDispatchHookInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "fee" | "fee()" | "hookType" | "hookType()" | "messageDispatched" | "messageDispatched(bytes32)" | "postDispatch" | "postDispatch(bytes,bytes)" | "quoteDispatch" | "quoteDispatch(bytes,bytes)" | "setFee" | "setFee(uint256)" | "supportsMetadata" | "supportsMetadata(bytes)"): FunctionFragment;
