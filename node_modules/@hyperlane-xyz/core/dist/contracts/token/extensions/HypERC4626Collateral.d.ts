...
export interface HypERC4626CollateralInterface extends utils.Interface {
    functions: {
        "NULL_RECIPIENT()": FunctionFragment;
        ...
        "rateUpdateNonce()": FunctionFragment;
        "rebase(uint32,bytes,address)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "NULL_RECIPIENT" | "NULL_RECIPIENT()" | "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "PRECISION" | "PRECISION()" | "balanceOf" | "balanceOf(address)" | "destinationGas" | "destinationGas(uint32)" | "domains" | "domains()" | "enrollRemoteRouter" | "enrollRemoteRouter(uint32,bytes32)" | "enrollRemoteRouters" | "enrollRemoteRouters(uint32[],bytes32[])" | "handle" | "handle(uint32,bytes32,bytes)" | "hook" | "hook()" | "initialize" | "initialize(address,address,address)" | "interchainSecurityModule" | "interchainSecurityModule()" | "localDomain" | "localDomain()" | "mailbox" | "mailbox()" | "owner" | "owner()" | "quoteGasPayment" | "quoteGasPayment(uint32)" | "rateUpdateNonce" | "rateUpdateNonce()" | "rebase" | "rebase(uint32,bytes,address)" | "renounceOwnership" | "renounceOwnership()" | "routers" | "routers(uint32)" | "setDestinationGas(uint32,uint256)" | "setDestinationGas((uint32,uint256)[])" | "setHook" | "setHook(address)" | "setInterchainSecurityModule" | "setInterchainSecurityModule(address)" | "transferOwnership" | "transferOwnership(address)" | "transferRemote(uint32,bytes32,uint256,bytes,address)" | "transferRemote(uint32,bytes32,uint256)" | "unenrollRemoteRouter" | "unenrollRemoteRouter(uint32)" | "unenrollRemoteRouters" | "unenrollRemoteRouters(uint32[])" | "vault" | "vault()" | "wrappedToken" | "wrappedToken()"): FunctionFragment;
    encodeFunctionData(functionFragment: "NULL_RECIPIENT", values?: undefined): string;
    encodeFunctionData(functionFragment: "NULL_RECIPIENT()", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "rateUpdateNonce", values?: undefined): string;
    encodeFunctionData(functionFragment: "rateUpdateNonce()", values?: undefined): string;
    encodeFunctionData(functionFragment: "rebase", values: [BigNumberish, BytesLike, string]): string;
    encodeFunctionData(functionFragment: "rebase(uint32,bytes,address)", values: [BigNumberish, BytesLike, string]): string;
    ...
    encodeFunctionData(functionFragment: "wrappedToken()", values?: undefined): string;
    decodeFunctionResult(functionFragment: "NULL_RECIPIENT", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "NULL_RECIPIENT()", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "rateUpdateNonce", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "rateUpdateNonce()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "rebase", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "rebase(uint32,bytes,address)", data: BytesLike): Result;
...
export interface HypERC4626Collateral extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HypERC4626CollateralInterface;
    ...
    functions: {
        NULL_RECIPIENT(overrides?: CallOverrides): Promise<[string]>;
        "NULL_RECIPIENT()"(overrides?: CallOverrides): Promise<[string]>;
        ...
        rateUpdateNonce(overrides?: CallOverrides): Promise<[number]>;
        "rateUpdateNonce()"(overrides?: CallOverrides): Promise<[number]>;
        rebase(_destinationDomain: BigNumberish, _hookMetadata: BytesLike, _hook: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "rebase(uint32,bytes,address)"(_destinationDomain: BigNumberish, _hookMetadata: BytesLike, _hook: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        rateUpdateNonce(overrides?: CallOverrides): Promise<number>;
        "rateUpdateNonce()"(overrides?: CallOverrides): Promise<number>;
        rebase(_destinationDomain: BigNumberish, _hookMetadata: BytesLike, _hook: string, overrides?: CallOverrides): Promise<void>;
        "rebase(uint32,bytes,address)"(_destinationDomain: BigNumberish, _hookMetadata: BytesLike, _hook: string, overrides?: CallOverrides): Promise<void>;
    ...
    estimateGas: {
        NULL_RECIPIENT(overrides?: CallOverrides): Promise<BigNumber>;
        "NULL_RECIPIENT()"(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        quoteGasPayment(_destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "quoteGasPayment(uint32)"(_destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        rateUpdateNonce(overrides?: CallOverrides): Promise<BigNumber>;
        "rateUpdateNonce()"(overrides?: CallOverrides): Promise<BigNumber>;
        rebase(_destinationDomain: BigNumberish, _hookMetadata: BytesLike, _hook: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<BigNumber>;
    ...
    populateTransaction: {
        NULL_RECIPIENT(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "NULL_RECIPIENT()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        rateUpdateNonce(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "rateUpdateNonce()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        rebase(_destinationDomain: BigNumberish, _hookMetadata: BytesLike, _hook: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=HypERC4626Collateral.d.ts.map