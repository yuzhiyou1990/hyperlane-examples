...
export interface HypERC4626Interface extends utils.Interface {
    functions: {
        "PACKAGE_VERSION()": FunctionFragment;
        "PRECISION()": FunctionFragment;
        "allowance(address,address)": FunctionFragment;
        "approve(address,uint256)": FunctionFragment;
        "assetsToShares(uint256)": FunctionFragment;
        "balanceOf(address)": FunctionFragment;
        "collateralDomain()": FunctionFragment;
        ...
        "previousNonce()": FunctionFragment;
        ...
        "sharesToAssets(uint256)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "PRECISION" | "PRECISION()" | "allowance" | "allowance(address,address)" | "approve" | "approve(address,uint256)" | "assetsToShares" | "assetsToShares(uint256)" | "balanceOf" | "balanceOf(address)" | "collateralDomain" | "collateralDomain()" | "decimals" | "decimals()" | "decreaseAllowance" | "decreaseAllowance(address,uint256)" | "destinationGas" | "destinationGas(uint32)" | "domains" | "domains()" | "enrollRemoteRouter" | "enrollRemoteRouter(uint32,bytes32)" | "enrollRemoteRouters" | "enrollRemoteRouters(uint32[],bytes32[])" | "exchangeRate" | "exchangeRate()" | "handle" | "handle(uint32,bytes32,bytes)" | "hook" | "hook()" | "increaseAllowance" | "increaseAllowance(address,uint256)" | "initialize" | "initialize(uint256,string,string,address,address,address)" | "interchainSecurityModule" | "interchainSecurityModule()" | "localDomain" | "localDomain()" | "mailbox" | "mailbox()" | "name" | "name()" | "owner" | "owner()" | "previousNonce" | "previousNonce()" | "quoteGasPayment" | "quoteGasPayment(uint32)" | "renounceOwnership" | "renounceOwnership()" | "routers" | "routers(uint32)" | "setDestinationGas(uint32,uint256)" | "setDestinationGas((uint32,uint256)[])" | "setHook" | "setHook(address)" | "setInterchainSecurityModule" | "setInterchainSecurityModule(address)" | "shareBalanceOf" | "shareBalanceOf(address)" | "sharesToAssets" | "sharesToAssets(uint256)" | "symbol" | "symbol()" | "totalShares" | "totalShares()" | "totalSupply" | "totalSupply()" | "transfer" | "transfer(address,uint256)" | "transferFrom" | "transferFrom(address,address,uint256)" | "transferOwnership" | "transferOwnership(address)" | "transferRemote(uint32,bytes32,uint256,bytes,address)" | "transferRemote(uint32,bytes32,uint256)" | "unenrollRemoteRouter" | "unenrollRemoteRouter(uint32)" | "unenrollRemoteRouters" | "unenrollRemoteRouters(uint32[])"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "assetsToShares(uint256)", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "balanceOf", values: [string]): string;
    encodeFunctionData(functionFragment: "balanceOf(address)", values: [string]): string;
    encodeFunctionData(functionFragment: "collateralDomain", values?: undefined): string;
    encodeFunctionData(functionFragment: "collateralDomain()", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "owner()", values?: undefined): string;
    encodeFunctionData(functionFragment: "previousNonce", values?: undefined): string;
    encodeFunctionData(functionFragment: "previousNonce()", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "shareBalanceOf", values: [string]): string;
    encodeFunctionData(functionFragment: "shareBalanceOf(address)", values: [string]): string;
    encodeFunctionData(functionFragment: "sharesToAssets", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "sharesToAssets(uint256)", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "assetsToShares(uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "balanceOf", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "balanceOf(address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "collateralDomain", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "collateralDomain()", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "owner()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "previousNonce", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "previousNonce()", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "shareBalanceOf", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "shareBalanceOf(address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "sharesToAssets", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "sharesToAssets(uint256)", data: BytesLike): Result;
    ...
    events: {
        ...
        "ExchangeRateUpdated(uint256,uint32)": EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "ExchangeRateUpdated(uint256,uint32)"): EventFragment;
...
export interface HypERC4626 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HypERC4626Interface;
    ...
    functions: {
        ...
        assetsToShares(_amount: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        "assetsToShares(uint256)"(_amount: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        balanceOf(account: string, overrides?: CallOverrides): Promise<[BigNumber]>;
        "balanceOf(address)"(account: string, overrides?: CallOverrides): Promise<[BigNumber]>;
        collateralDomain(overrides?: CallOverrides): Promise<[number]>;
        "collateralDomain()"(overrides?: CallOverrides): Promise<[number]>;
        ...
        "owner()"(overrides?: CallOverrides): Promise<[string]>;
        previousNonce(overrides?: CallOverrides): Promise<[number]>;
        "previousNonce()"(overrides?: CallOverrides): Promise<[number]>;
        ...
        shareBalanceOf(account: string, overrides?: CallOverrides): Promise<[BigNumber]>;
        "shareBalanceOf(address)"(account: string, overrides?: CallOverrides): Promise<[BigNumber]>;
        sharesToAssets(_shares: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        "sharesToAssets(uint256)"(_shares: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        "transferFrom(address,address,uint256)"(sender: string, recipient: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    filters: {
        ...
        "ExchangeRateUpdated(uint256,uint32)"(newExchangeRate?: null, rateUpdateNonce?: null): ExchangeRateUpdatedEventFilter;
        ExchangeRateUpdated(newExchangeRate?: null, rateUpdateNonce?: null): ExchangeRateUpdatedEventFilter;
    ...
    estimateGas: {
        ...
        balanceOf(account: string, overrides?: CallOverrides): Promise<BigNumber>;
        "balanceOf(address)"(account: string, overrides?: CallOverrides): Promise<BigNumber>;
        collateralDomain(overrides?: CallOverrides): Promise<BigNumber>;
        "collateralDomain()"(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        "owner()"(overrides?: CallOverrides): Promise<BigNumber>;
        previousNonce(overrides?: CallOverrides): Promise<BigNumber>;
        "previousNonce()"(overrides?: CallOverrides): Promise<BigNumber>;
        quoteGasPayment(_destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "quoteGasPayment(uint32)"(_destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        renounceOwnership(overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        assetsToShares(_amount: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "assetsToShares(uint256)"(_amount: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        balanceOf(account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "balanceOf(address)"(account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        collateralDomain(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "collateralDomain()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        "owner()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        previousNonce(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "previousNonce()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        shareBalanceOf(account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "shareBalanceOf(address)"(account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        sharesToAssets(_shares: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "sharesToAssets(uint256)"(_shares: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=HypERC4626.d.ts.map