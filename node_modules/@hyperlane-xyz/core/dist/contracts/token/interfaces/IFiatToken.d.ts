...
export interface IFiatTokenInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "allowance(address,address)" | "approve" | "approve(address,uint256)" | "balanceOf" | "balanceOf(address)" | "burn" | "burn(uint256)" | "mint" | "mint(address,uint256)" | "totalSupply" | "totalSupply()" | "transfer" | "transfer(address,uint256)" | "transferFrom" | "transferFrom(address,address,uint256)"): FunctionFragment;
...
export interface IFiatToken extends BaseContract {
    ...
    functions: {
        ...
        "mint(address,uint256)"(_to: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
...
//# sourceMappingURL=IFiatToken.d.ts.map