...
export interface IXERC20Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "allowance(address,address)" | "approve" | "approve(address,uint256)" | "balanceOf" | "balanceOf(address)" | "burn" | "burn(address,uint256)" | "burningCurrentLimitOf" | "burningCurrentLimitOf(address)" | "burningMaxLimitOf" | "burningMaxLimitOf(address)" | "mint" | "mint(address,uint256)" | "mintingCurrentLimitOf" | "mintingCurrentLimitOf(address)" | "mintingMaxLimitOf" | "mintingMaxLimitOf(address)" | "owner" | "owner()" | "setLimits" | "setLimits(address,uint256,uint256)" | "totalSupply" | "totalSupply()" | "transfer" | "transfer(address,uint256)" | "transferFrom" | "transferFrom(address,address,uint256)"): FunctionFragment;
...
export interface IXERC20 extends BaseContract {
    ...
    functions: {
        ...
        mintingMaxLimitOf(_minter: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            _limit: BigNumber;
        }>;
        "mintingMaxLimitOf(address)"(_minter: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            _limit: BigNumber;
        }>;
    ...
    populateTransaction: {
        ...
        mintingMaxLimitOf(_minter: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "mintingMaxLimitOf(address)"(_minter: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        owner(overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        "owner()"(overrides?: Overrides & {
