...
export interface HypNative extends BaseContract {
    ...
    functions: {
        ...
        "transferRemote(uint32,bytes32,uint256,bytes,address)"(_destination: BigNumberish, _recipient: BytesLike, _amount: BigNumberish, _hookMetadata: BytesLike, _hook: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "transferRemote(uint32,bytes32,uint256,bytes,address)"(_destination: BigNumberish, _recipient: BytesLike, _amount: BigNumberish, _hookMetadata: BytesLike, _hook: string, overrides?: CallOverrides): Promise<string>;
