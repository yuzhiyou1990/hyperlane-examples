...
export interface AbstractPostDispatchHookInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "hookType" | "hookType()" | "postDispatch" | "postDispatch(bytes,bytes)" | "quoteDispatch" | "quoteDispatch(bytes,bytes)" | "supportsMetadata" | "supportsMetadata(bytes)"): FunctionFragment;
