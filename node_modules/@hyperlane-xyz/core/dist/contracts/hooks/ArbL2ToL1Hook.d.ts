...
export interface ArbL2ToL1HookInterface extends utils.Interface {
    functions: {
...
export interface ArbL2ToL1Hook extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ArbL2ToL1HookInterface;
...
//# sourceMappingURL=ArbL2ToL1Hook.d.ts.map