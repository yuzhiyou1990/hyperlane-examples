...
export interface StaticAggregationHookInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "hookType" | "hookType()" | "hooks" | "hooks(bytes)" | "postDispatch" | "postDispatch(bytes,bytes)" | "quoteDispatch" | "quoteDispatch(bytes,bytes)" | "supportsMetadata" | "supportsMetadata(bytes)"): FunctionFragment;
