...
export interface OPL2ToL1HookInterface extends utils.Interface {
    functions: {
        "MIN_GAS_LIMIT()": FunctionFragment;
        "PACKAGE_VERSION()": FunctionFragment;
        "childHook()": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "MIN_GAS_LIMIT" | "MIN_GAS_LIMIT()" | "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "childHook" | "childHook()" | "destinationDomain" | "destinationDomain()" | "hook" | "hook()" | "hookType" | "hookType()" | "interchainSecurityModule" | "interchainSecurityModule()" | "ism" | "ism()" | "l2Messenger" | "l2Messenger()" | "localDomain" | "localDomain()" | "mailbox" | "mailbox()" | "owner" | "owner()" | "postDispatch" | "postDispatch(bytes,bytes)" | "quoteDispatch" | "quoteDispatch(bytes,bytes)" | "renounceOwnership" | "renounceOwnership()" | "setHook" | "setHook(address)" | "setInterchainSecurityModule" | "setInterchainSecurityModule(address)" | "supportsMetadata" | "supportsMetadata(bytes)" | "transferOwnership" | "transferOwnership(address)"): FunctionFragment;
    encodeFunctionData(functionFragment: "MIN_GAS_LIMIT", values?: undefined): string;
    encodeFunctionData(functionFragment: "MIN_GAS_LIMIT()", values?: undefined): string;
    encodeFunctionData(functionFragment: "PACKAGE_VERSION", values?: undefined): string;
    encodeFunctionData(functionFragment: "PACKAGE_VERSION()", values?: undefined): string;
    encodeFunctionData(functionFragment: "childHook", values?: undefined): string;
    encodeFunctionData(functionFragment: "childHook()", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "MIN_GAS_LIMIT", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "MIN_GAS_LIMIT()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "PACKAGE_VERSION", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "PACKAGE_VERSION()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "childHook", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "childHook()", data: BytesLike): Result;
...
export interface OPL2ToL1Hook extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: OPL2ToL1HookInterface;
    ...
    functions: {
        MIN_GAS_LIMIT(overrides?: CallOverrides): Promise<[number]>;
        "MIN_GAS_LIMIT()"(overrides?: CallOverrides): Promise<[number]>;
        PACKAGE_VERSION(overrides?: CallOverrides): Promise<[string]>;
        "PACKAGE_VERSION()"(overrides?: CallOverrides): Promise<[string]>;
        childHook(overrides?: CallOverrides): Promise<[string]>;
        "childHook()"(overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        MIN_GAS_LIMIT(overrides?: CallOverrides): Promise<BigNumber>;
        "MIN_GAS_LIMIT()"(overrides?: CallOverrides): Promise<BigNumber>;
        PACKAGE_VERSION(overrides?: CallOverrides): Promise<BigNumber>;
        "PACKAGE_VERSION()"(overrides?: CallOverrides): Promise<BigNumber>;
        childHook(overrides?: CallOverrides): Promise<BigNumber>;
        "childHook()"(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        MIN_GAS_LIMIT(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "MIN_GAS_LIMIT()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        PACKAGE_VERSION(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "PACKAGE_VERSION()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        childHook(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "childHook()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=OPL2ToL1Hook.d.ts.map