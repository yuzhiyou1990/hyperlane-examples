...
export interface IValidatorAnnounceInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "announce" | "announce(address,string,bytes)" | "getAnnouncedStorageLocations" | "getAnnouncedStorageLocations(address[])" | "getAnnouncedValidators" | "getAnnouncedValidators()"): FunctionFragment;
