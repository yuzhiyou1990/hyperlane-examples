...
export interface IRouterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "domains" | "domains()" | "enrollRemoteRouter" | "enrollRemoteRouter(uint32,bytes32)" | "enrollRemoteRouters" | "enrollRemoteRouters(uint32[],bytes32[])" | "routers" | "routers(uint32)"): FunctionFragment;
...
export interface IRouter extends BaseContract {
    ...
    functions: {
        ...
        "enrollRemoteRouters(uint32[],bytes32[])"(_domains: BigNumberish[], _routers: BytesLike[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "enrollRemoteRouters(uint32[],bytes32[])"(_domains: BigNumberish[], _routers: BytesLike[], overrides?: CallOverrides): Promise<void>;
        routers(_domain: BigNumberish, overrides?: CallOverrides): Promise<string>;
        "routers(uint32)"(_domain: BigNumberish, overrides?: CallOverrides): Promise<string>;
    };
    filters: {};
