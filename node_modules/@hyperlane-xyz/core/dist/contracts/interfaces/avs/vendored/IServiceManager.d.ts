...
export interface IServiceManagerInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "avsDirectory" | "avsDirectory()" | "deregisterOperatorFromAVS" | "deregisterOperatorFromAVS(address)" | "getOperatorRestakedStrategies" | "getOperatorRestakedStrategies(address)" | "getRestakeableStrategies" | "getRestakeableStrategies()" | "payForRange" | "payForRange(((address,uint96)[],address,uint256,uint64,uint64)[])" | "registerOperatorToAVS" | "registerOperatorToAVS(address,(bytes,bytes32,uint256))" | "updateAVSMetadataURI" | "updateAVSMetadataURI(string)"): FunctionFragment;
...
export interface IServiceManager extends BaseContract {
    ...
    functions: {
        ...
        getOperatorRestakedStrategies(operator: string, overrides?: CallOverrides): Promise<[string[]]>;
        "getOperatorRestakedStrategies(address)"(operator: string, overrides?: CallOverrides): Promise<[string[]]>;
    ...
    estimateGas: {
        ...
        getOperatorRestakedStrategies(operator: string, overrides?: CallOverrides): Promise<BigNumber>;
        "getOperatorRestakedStrategies(address)"(operator: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getOperatorRestakedStrategies(operator: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "getOperatorRestakedStrategies(address)"(operator: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=IServiceManager.d.ts.map