...
export interface IDelegationManagerInterface extends utils.Interface {
    ...
    getEvent(nameOrSignatureOrTopic: "OperatorMetadataURIUpdated(address,string)"): EventFragment;
}
...
export type OperatorMetadataURIUpdatedEventFilter = TypedEventFilter<OperatorMetadataURIUpdatedEvent>;
