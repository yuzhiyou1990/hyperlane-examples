...
export interface IInterchainGasPaymasterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "payForGas" | "payForGas(bytes32,uint32,uint256,address)" | "quoteGasPayment" | "quoteGasPayment(uint32,uint256)"): FunctionFragment;
...
export interface IInterchainGasPaymaster extends BaseContract {
    ...
    functions: {
        ...
        "payForGas(bytes32,uint32,uint256,address)"(_messageId: BytesLike, _destinationDomain: BigNumberish, _gasAmount: BigNumberish, _refundAddress: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        quoteGasPayment(_destinationDomain: BigNumberish, _gasAmount: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        "quoteGasPayment(uint32,uint256)"(_destinationDomain: BigNumberish, _gasAmount: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
    };
    payForGas(_messageId: BytesLike, _destinationDomain: BigNumberish, _gasAmount: BigNumberish, _refundAddress: string, overrides?: PayableOverrides & {
        from?: string;
    }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "payForGas(bytes32,uint32,uint256,address)"(_messageId: BytesLike, _destinationDomain: BigNumberish, _gasAmount: BigNumberish, _refundAddress: string, overrides?: CallOverrides): Promise<void>;
        quoteGasPayment(_destinationDomain: BigNumberish, _gasAmount: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "quoteGasPayment(uint32,uint256)"(_destinationDomain: BigNumberish, _gasAmount: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {
    ...
    populateTransaction: {
        ...
        "quoteGasPayment(uint32,uint256)"(_destinationDomain: BigNumberish, _gasAmount: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
