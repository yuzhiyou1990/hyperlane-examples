...
export interface IBridgeInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "updateRollupAddress(address)", values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: "updateRollupAddress(address)", data: BytesLike): Result;
    events: {
    ...
    getEvent(nameOrSignatureOrTopic: "RollupUpdated(address)"): EventFragment;
...
export interface IBridge extends BaseContract {
    ...
    functions: {
        ...
        "updateRollupAddress(address)"(_rollup: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    activeOutbox(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        "updateRollupAddress(address)"(_rollup: string, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
