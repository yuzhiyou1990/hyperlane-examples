...
export interface IOutboxInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "OUTBOX_VERSION" | "OUTBOX_VERSION()" | "bridge" | "bridge()" | "calculateItemHash" | "calculateItemHash(address,address,uint256,uint256,uint256,uint256,bytes)" | "calculateMerkleRoot" | "calculateMerkleRoot(bytes32[],uint256,bytes32)" | "executeTransaction" | "executeTransaction(bytes32[],uint256,address,address,uint256,uint256,uint256,uint256,bytes)" | "executeTransactionSimulation" | "executeTransactionSimulation(uint256,address,address,uint256,uint256,uint256,uint256,bytes)" | "initialize" | "initialize(address)" | "isSpent" | "isSpent(uint256)" | "l2ToL1Block" | "l2ToL1Block()" | "l2ToL1EthBlock" | "l2ToL1EthBlock()" | "l2ToL1OutputId" | "l2ToL1OutputId()" | "l2ToL1Sender" | "l2ToL1Sender()" | "l2ToL1Timestamp" | "l2ToL1Timestamp()" | "postUpgradeInit" | "postUpgradeInit()" | "rollup" | "rollup()" | "roots" | "roots(bytes32)" | "spent" | "spent(uint256)" | "updateRollupAddress" | "updateRollupAddress()" | "updateSendRoot" | "updateSendRoot(bytes32,bytes32)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "calculateItemHash(address,address,uint256,uint256,uint256,uint256,bytes)", values: [
        string,
        string,
        BigNumberish,
        BigNumberish,
    ...
    encodeFunctionData(functionFragment: "calculateMerkleRoot(bytes32[],uint256,bytes32)", values: [BytesLike[], BigNumberish, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "executeTransaction(bytes32[],uint256,address,address,uint256,uint256,uint256,uint256,bytes)", values: [
        BytesLike[],
        BigNumberish,
        string,
        string,
    ...
    encodeFunctionData(functionFragment: "executeTransactionSimulation(uint256,address,address,uint256,uint256,uint256,uint256,bytes)", values: [
        BigNumberish,
        string,
        string,
        BigNumberish,
    ...
    encodeFunctionData(functionFragment: "isSpent(uint256)", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "roots(bytes32)", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "spent", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "spent(uint256)", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "updateSendRoot(bytes32,bytes32)", values: [BytesLike, BytesLike]): string;
    ...
    decodeFunctionResult(functionFragment: "calculateItemHash(address,address,uint256,uint256,uint256,uint256,bytes)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "calculateMerkleRoot", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "calculateMerkleRoot(bytes32[],uint256,bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "executeTransaction", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "executeTransaction(bytes32[],uint256,address,address,uint256,uint256,uint256,uint256,bytes)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "executeTransactionSimulation", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "executeTransactionSimulation(uint256,address,address,uint256,uint256,uint256,uint256,bytes)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "initialize", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "initialize(address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "isSpent", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "isSpent(uint256)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "roots(bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "spent", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "spent(uint256)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "updateSendRoot(bytes32,bytes32)", data: BytesLike): Result;
    events: {
    ...
    getEvent(nameOrSignatureOrTopic: "OutBoxTransactionExecuted(address,address,uint256,uint256)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "SendRootUpdated"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "SendRootUpdated(bytes32,bytes32)"): EventFragment;
}
...
export interface IOutbox extends BaseContract {
    ...
    functions: {
        ...
        "calculateItemHash(address,address,uint256,uint256,uint256,uint256,bytes)"(l2Sender: string, to: string, l2Block: BigNumberish, l1Block: BigNumberish, l2Timestamp: BigNumberish, value: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<[string]>;
        calculateMerkleRoot(proof: BytesLike[], path: BigNumberish, item: BytesLike, overrides?: CallOverrides): Promise<[string]>;
        "calculateMerkleRoot(bytes32[],uint256,bytes32)"(proof: BytesLike[], path: BigNumberish, item: BytesLike, overrides?: CallOverrides): Promise<[string]>;
        ...
        "executeTransaction(bytes32[],uint256,address,address,uint256,uint256,uint256,uint256,bytes)"(proof: BytesLike[], index: BigNumberish, l2Sender: string, to: string, l2Block: BigNumberish, l1Block: BigNumberish, l2Timestamp: BigNumberish, value: BigNumberish, data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "executeTransactionSimulation(uint256,address,address,uint256,uint256,uint256,uint256,bytes)"(index: BigNumberish, l2Sender: string, to: string, l2Block: BigNumberish, l1Block: BigNumberish, l2Timestamp: BigNumberish, value: BigNumberish, data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        initialize(_bridge: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "initialize(address)"(_bridge: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        isSpent(index: BigNumberish, overrides?: CallOverrides): Promise<[boolean]>;
        "isSpent(uint256)"(index: BigNumberish, overrides?: CallOverrides): Promise<[boolean]>;
        ...
        "spent(uint256)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        ...
        "updateSendRoot(bytes32,bytes32)"(sendRoot: BytesLike, l2BlockHash: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    OUTBOX_VERSION(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    callStatic: {
        ...
        "executeTransaction(bytes32[],uint256,address,address,uint256,uint256,uint256,uint256,bytes)"(proof: BytesLike[], index: BigNumberish, l2Sender: string, to: string, l2Block: BigNumberish, l1Block: BigNumberish, l2Timestamp: BigNumberish, value: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<void>;
        ...
        "executeTransactionSimulation(uint256,address,address,uint256,uint256,uint256,uint256,bytes)"(index: BigNumberish, l2Sender: string, to: string, l2Block: BigNumberish, l1Block: BigNumberish, l2Timestamp: BigNumberish, value: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<void>;
        initialize(_bridge: string, overrides?: CallOverrides): Promise<void>;
        "initialize(address)"(_bridge: string, overrides?: CallOverrides): Promise<void>;
        isSpent(index: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        "isSpent(uint256)"(index: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        l2ToL1Block(overrides?: CallOverrides): Promise<BigNumber>;
        "l2ToL1Block()"(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        "updateSendRoot(bytes32,bytes32)"(sendRoot: BytesLike, l2BlockHash: BytesLike, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
    ...
    estimateGas: {
        ...
        "calculateItemHash(address,address,uint256,uint256,uint256,uint256,bytes)"(l2Sender: string, to: string, l2Block: BigNumberish, l1Block: BigNumberish, l2Timestamp: BigNumberish, value: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        calculateMerkleRoot(proof: BytesLike[], path: BigNumberish, item: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        "calculateMerkleRoot(bytes32[],uint256,bytes32)"(proof: BytesLike[], path: BigNumberish, item: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        executeTransaction(proof: BytesLike[], index: BigNumberish, l2Sender: string, to: string, l2Block: BigNumberish, l1Block: BigNumberish, l2Timestamp: BigNumberish, value: BigNumberish, data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        "executeTransaction(bytes32[],uint256,address,address,uint256,uint256,uint256,uint256,bytes)"(proof: BytesLike[], index: BigNumberish, l2Sender: string, to: string, l2Block: BigNumberish, l1Block: BigNumberish, l2Timestamp: BigNumberish, value: BigNumberish, data: BytesLike, overrides?: Overrides & {
        ...
        "isSpent(uint256)"(index: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        l2ToL1Block(overrides?: CallOverrides): Promise<BigNumber>;
        "l2ToL1Block()"(overrides?: CallOverrides): Promise<BigNumber>;
        l2ToL1EthBlock(overrides?: CallOverrides): Promise<BigNumber>;
        "l2ToL1EthBlock()"(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        "roots(bytes32)"(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        spent(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "spent(uint256)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        updateRollupAddress(overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        "updateRollupAddress()"(overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        "calculateItemHash(address,address,uint256,uint256,uint256,uint256,bytes)"(l2Sender: string, to: string, l2Block: BigNumberish, l1Block: BigNumberish, l2Timestamp: BigNumberish, value: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        "calculateMerkleRoot(bytes32[],uint256,bytes32)"(proof: BytesLike[], path: BigNumberish, item: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        executeTransaction(proof: BytesLike[], index: BigNumberish, l2Sender: string, to: string, l2Block: BigNumberish, l1Block: BigNumberish, l2Timestamp: BigNumberish, value: BigNumberish, data: BytesLike, overrides?: Overrides & {
            from?: string;
        ...
        "isSpent(uint256)"(index: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        "roots(bytes32)"(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        spent(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "spent(uint256)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        updateRollupAddress(overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        "updateRollupAddress()"(overrides?: Overrides & {
