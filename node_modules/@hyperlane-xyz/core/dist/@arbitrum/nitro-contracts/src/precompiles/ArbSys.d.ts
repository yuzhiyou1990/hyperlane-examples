...
export interface ArbSysInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "arbBlockHash" | "arbBlockHash(uint256)" | "arbBlockNumber" | "arbBlockNumber()" | "arbChainID" | "arbChainID()" | "arbOSVersion" | "arbOSVersion()" | "getStorageGasAvailable" | "getStorageGasAvailable()" | "isTopLevelCall" | "isTopLevelCall()" | "mapL1SenderContractAddressToL2Alias" | "mapL1SenderContractAddressToL2Alias(address,address)" | "myCallersAddressWithoutAliasing" | "myCallersAddressWithoutAliasing()" | "sendMerkleTreeState" | "sendMerkleTreeState()" | "sendTxToL1" | "sendTxToL1(address,bytes)" | "wasMyCallersAddressAliased" | "wasMyCallersAddressAliased()" | "withdrawEth" | "withdrawEth(address)"): FunctionFragment;
    encodeFunctionData(functionFragment: "arbBlockHash", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "arbBlockHash(uint256)", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "mapL1SenderContractAddressToL2Alias(address,address)", values: [string, string]): string;
    ...
    encodeFunctionData(functionFragment: "sendTxToL1(address,bytes)", values: [string, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "withdrawEth(address)", values: [string]): string;
    decodeFunctionResult(functionFragment: "arbBlockHash", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "arbBlockHash(uint256)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "mapL1SenderContractAddressToL2Alias(address,address)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "sendTxToL1(address,bytes)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "withdrawEth(address)", data: BytesLike): Result;
    events: {
    ...
    getEvent(nameOrSignatureOrTopic: "L2ToL1Transaction(address,address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,bytes)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "L2ToL1Tx"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "L2ToL1Tx(address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "SendMerkleUpdate"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "SendMerkleUpdate(uint256,bytes32,uint256)"): EventFragment;
}
...
export interface ArbSys extends BaseContract {
    ...
    functions: {
        ...
        "arbBlockHash(uint256)"(arbBlockNum: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        ...
        "mapL1SenderContractAddressToL2Alias(address,address)"(sender: string, unused: string, overrides?: CallOverrides): Promise<[string]>;
        ...
        "sendTxToL1(address,bytes)"(destination: string, data: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "withdrawEth(address)"(destination: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    arbBlockHash(arbBlockNum: BigNumberish, overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        "sendTxToL1(address,bytes)"(destination: string, data: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        wasMyCallersAddressAliased(overrides?: CallOverrides): Promise<boolean>;
        "wasMyCallersAddressAliased()"(overrides?: CallOverrides): Promise<boolean>;
        withdrawEth(destination: string, overrides?: CallOverrides): Promise<BigNumber>;
        "withdrawEth(address)"(destination: string, overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {
    ...
    estimateGas: {
        ...
        "arbBlockHash(uint256)"(arbBlockNum: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        arbBlockNumber(overrides?: CallOverrides): Promise<BigNumber>;
        "arbBlockNumber()"(overrides?: CallOverrides): Promise<BigNumber>;
        arbChainID(overrides?: CallOverrides): Promise<BigNumber>;
        "arbChainID()"(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        "mapL1SenderContractAddressToL2Alias(address,address)"(sender: string, unused: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        "arbBlockHash(uint256)"(arbBlockNum: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        "mapL1SenderContractAddressToL2Alias(address,address)"(sender: string, unused: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=ArbSys.d.ts.map