...
import { ERC20Test__factory, ERC4626Test__factory, Mailbox__factory, } from '@hyperlane-xyz/core';
...
describe('ERC20WarpRouterReader', async () => {
    ...
    it('should derive collateral config correctly', async () => {
        ...
        // Check ism
        expect(derivedConfig.interchainSecurityModule.address).to.be.equal(await mailbox.defaultIsm());
    ...
    it('should return the remote routers', async () => {
        ...
        expect(derivedConfig.remoteRouters[otherChainMetadata.domainId]).to.be.equal(warpRoute[otherChain].collateral.address);
    });
});
//# sourceMappingURL=EvmERC20WarpRouteReader.hardhat-test.js.map