...
import { assert, deepEquals, eqAddress } from '@hyperlane-xyz/utils';
...
function randomHookType() {
    ...
    const filteredHookTypes = hookTypes.filter((type) => type !== HookType.OP_STACK &&
...
function randomHookConfig(depth = 0, maxDepth = 2, providedHookType) {
...
describe('EvmHookModule', async () => {
    ...
    before(async () => {
        ...
        const { mailbox, proxyAdmin, validatorAnnounce } = (await testCoreDeployer.deployApp()).getContracts(chain);
        coreAddresses = {
