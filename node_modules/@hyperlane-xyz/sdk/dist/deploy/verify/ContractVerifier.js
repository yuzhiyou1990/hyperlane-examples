...
export class ContractVerifier {
    ...
    filterStandardInputJsonByContractName(contractName, input, verificationLogger) {
        ...
        const contractFile = this.getContractFile(contractName, sourceFiles);
    ...
    getContractFile(contractName, sourceFiles) {
        const contractFile = sourceFiles.find((file) => file.endsWith(`/${contractName}.sol`));
        if (!contractFile) {
