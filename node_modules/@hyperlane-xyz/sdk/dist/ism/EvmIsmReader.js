...
import { ArbL2ToL1Ism__factory, DefaultFallbackRoutingIsm__factory, IInterchainSecurityModule__factory, IMultisigIsm__factory, IOutbox__factory, OPStackIsm__factory, PausableIsm__factory, StaticAggregationIsm__factory, TrustedRelayerIsm__factory, } from '@hyperlane-xyz/core';
import { assert, concurrentMap, getLogLevel, rootLogger, } from '@hyperlane-xyz/utils';
...
export class EvmIsmReader extends HyperlaneReader {
    ...
    async deriveRoutingConfig(address) {
        const ism = DefaultFallbackRoutingIsm__factory.connect(address, this.provider);
    ...
    async deriveMultisigConfig(address) {
        ...
        const ismType = moduleType === ModuleType.MERKLE_ROOT_MULTISIG
