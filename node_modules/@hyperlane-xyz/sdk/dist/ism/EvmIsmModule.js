...
import { assert, deepEquals, intersection, rootLogger, } from '@hyperlane-xyz/utils';
import { transferOwnershipTransactions } from '../contracts/contracts.js';
import { HyperlaneModule, } from '../core/AbstractHyperlaneModule.js';
import { normalizeConfig } from '../utils/ism.js';
import { EvmIsmReader } from './EvmIsmReader.js';
import { HyperlaneIsmFactory } from './HyperlaneIsmFactory.js';
import { IsmConfigSchema, IsmType, MUTABLE_ISM_TYPE, } from './types.js';
...
export class EvmIsmModule extends HyperlaneModule {
    ...
    constructor(multiProvider, params, contractVerifier) {
        ...
        this.ismFactory = HyperlaneIsmFactory.fromAddressesMap({ [params.chain]: params.addresses }, multiProvider);
    ...
    async update(targetConfig) {
        ...
        assert(typeof targetConfig === 'object', 'normalized targetConfig should be an object');
        ...
        let updateTxs = [];
        if (targetConfig.type === IsmType.ROUTING ||
            targetConfig.type === IsmType.FALLBACK_ROUTING) {
        ...
        updateTxs.push(...transferOwnershipTransactions(this.chainId, this.args.addresses.deployedIsm, currentConfig, targetConfig));
        return updateTxs;
    }
    // manually write static create function
    static async create({ chain, config, proxyFactoryFactories, mailbox, multiProvider, contractVerifier, }) {
