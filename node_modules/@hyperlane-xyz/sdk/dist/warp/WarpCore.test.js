...
import { test1, test2, testCosmosChain, testSealevelChain, } from '../consts/testChains.js';
...
describe('WarpCore', () => {
    ...
    it('Gets transfer gas quote', async () => {
        ...
        const testQuote = async (token, destination, standard, interchainQuote = MOCK_INTERCHAIN_QUOTE) => {
            ...
            expect(result.interchainQuote.amount, `token interchain amount check for ${token.chainName} to ${destination}`).to.equal(interchainQuote.amount);
        };
    ...
    it('Gets transfer remote txs', async () => {
        ...
        const testGetTxs = async (token, destination, providerType = ProviderType.EthersV5) => {
